const db_pre19c = [
    {
        id: 1,
        title: "Fuggerorum et Fuggerarum",
        year: "Fugger",
        description: "在整个15世纪和16世纪，来自奥格斯堡的Fugger家族成为欧洲最强大的商人王朝之一。他们取代德美第奇家族可能是欧洲最具影响力的家族，接管了许多美第奇家族的资产以及他们的政治权力和影响力。在16世纪初，Fuggers在本世纪下半叶开始从商业开始逐步退出，随着17世纪开始采用贵族生活方式。雅各布·福格尔于1525年去世，被认为是有史以来最富有的人之一，今天被称为雅各布·富格尔的“富人”。下面的一系列图像是Fuggerorum et Fuggerarum的选择。 Quae in familia natae。 Quaève在familiam transiervnt。引用现存的aere expressae想象，限量版的高度精细的彩色版画，专门在1593年和1618年为他们描绘的家庭成员出版。这项工作由Philipp Eduard Fugger委托进行，大部分由奥格斯堡雕刻家Dominicus Custos执行（另见他的Atrium Heroicum）",
        colors: ["#d3a395", "#e3b8a8", "#b67281", "#d8a39d", "#aa3126"],
    }, {
        id: 2,
        title: "The Celestial Atlas of Andreas Cellarius (1660)",
        year: "Andreas Cellarius",
        description: "Harmonia Macrocosmica（1660年）是荷兰黄金时代制图中的恒星地图集，以29个非凡的双对开页展示了天空的结构。向我们展示了天体的运动，北半球的恒星星座，托勒密的旧地心宇宙，哥白尼的新日心说，以及第二轮的第二组 - 这是月球围绕地球运行的古怪组合。行星围绕太阳运行，但太阳仍在地球上运行。每个颜色鲜艳的地图的边缘区域都是一个活动场所：天文学家在图表上争论他们的发现，热切的年轻人将他们的象限引向天空，小天使们带着宠物鸟飞来飞去。荷兰 - 德国创作者安德烈亚斯·塞拉里乌斯（Andreas Cellarius）的生活只是以骨架的形式传达给我们。他出生于1596年左右，在沃尔姆斯附近的一个小镇上，在阿姆斯特丹，海牙和最后的霍恩度过了他的成年生活。大约在1637年，他被任命为Hoorn拉丁学校的校长，在那里他编写了Harmonia Macrocosmica和他所有的其他学术着作（包括一个关于设计坚不可摧的防御工事）。作为关于宇宙学的两卷论文的历史性介绍，只有第一部分由阿姆斯特丹出版商Johannes Janssonius于1660年印制，才得以实现。在Cellarius去世后大约四十年左右，阿姆斯特丹出版商Gerard Valk和Petrus Schenk the Younger发布了一个版本只包含这些版块，并且正是这个版本中的许多图像来自后期版本。我们在这里展示的亮点全部来自斯坦福大学图书馆的数字存储库，但是在两个单独的集合中，每个集合都有不同的共享和重用许可证。其中六个来自加利福尼亚州的格伦麦克劳林地图集，并以公共领域标记出版，其中七个来自巴里劳伦斯鲁德曼地图集，其中（令人沮丧地，似乎没有充分理由）在CC BY-NC-SA下发布。许可证（所以要小心你如何使用它们）。2006年，Taschen对Harmonia Macrocosmica进行了大规模的重印，并由Robert Van Gent撰写评论。我们还在网上商店中提供了选择。",
        colors: ["#d07b82", "#bf6461", "#d9ac95", "#daa796", "#c97a75"],
    }, {
        id: 3,
        title: "The Garden of Earthly Delights (1490)",
        year: "Hieronymus Bosch",
        description: "在1490年至1510年间的某个时间，“人间花园”可能是Hieronymus Bosch最雄心勃勃的作品。由三个面板组成，总长度近四米，三联画是一个令人眼花缭乱的细节和令人愉快的超现实作品，其可能的意义使学者们忙碌了几个世纪。左侧小组 - 有时被称为亚当和夏娃的加入 - 是伊甸园中天堂般的场景的所在地，很可能是上帝将夏娃呈现给亚当的那一刻。虽然它在圣经故事中显然有其路线，但博世特别注意它 - 以其奇怪的野兽，亚当几乎是淫荡的目光 - 与西方艺术史上所描绘的任何其他东西不同。中间面板，三者中最大的，似乎从“第一”继续（三联画很可能是从左到右阅读），他们的天际线匹配。这些设置似乎也相互呼应，尽管中间面板的音调完全不同。在这里，场景是一个肆无忌惮的嬉戏，充满了裸体人物的景观，以及各种超大的动物，植物和巨大的水果 - 真实和幻想的混合。有这么多的嬉皮裸体，面板无疑是色情元素，但却带着一种纯真的感觉。根据博世学者威廉·弗兰格（Wilhelm Fraenger）的说法，这种色情主义含糊不清，既是精神过渡的寓言，也是腐败的游乐场。正确的面板与其他面板明显不同，显然是对地狱的描绘，这是博世作品的熟悉场景。他并没有退缩。这个场景尖叫着奇怪和噩梦般的图像：持刀的巨型耳朵，吃人的鸟怪，猪修女的不必要的进展，以及一个非凡的画面，一个巨大的粉红色怪物，唱着人体背面印有的乐谱。关闭左右面板揭示了这件作品的外部面板：几乎可以肯定的是对世界创造的描绘。在左上角可以看到上帝的小人物，在他的上方刻有诗篇33篇的引文 -  Ipse dixit，以及其他事实：ipsemandāvit，etcreatta sunt  - 因为他说话并且已经完成;他命令道，它站得很快。",
